    ...
    <>
      ...
      <div className="w-full pb-[1235px] md:pb-5 bg-white-A700">
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col w-full mt-[9px] gap-[19px] mx-auto md:p-5 max-w-[1320px]">
              ...
              <div className="h-[596px] md:h-auto relative">
                <div className="flex sm:flex-col justify-center items-center w-[45%] h-max right-[0.00px] bottom-0 top-0 my-auto absolute sm:relative">
                  <div className="flex self-end justify-center w-[28%] sm:w-full mb-[13px] z-[1]">
                    <div className="flex justify-center items-start w-full gap-[15px] bottom-[85px] p-3.5 bg-deep_purple-600 relative rounded-[5px]">
                ...
                <div className="flex md:flex-col justify-center items-start w-full">
                  ...
                  <Img
                    ...
                    alt="image_one"
                    className="w-[50%] md:w-full ml-[-109px] p-5 top-[70px] left-2.5 md:ml-0 relative object-cover block rounded-[20px]"
                  />
                </div>
                <Text
                  size="s"
            ...
            <div className="flex flex-col items-center gap-7 overflow-auto">
              ...
              <div className="flex md:flex-col justify-between items-center w-full gap-5 mx-auto md:p-5 max-w-[1714px]">
                ...
                <Img
                  ...
                  alt="kisspngnokian"
                  className="w-[8%] md:w-full object-cover"
                />
                ...
                <div className="flex justify-end w-full bg-white-A700_01">
                  <div className="flex flex-col w-full mb-[59px] gap-[38px]">
                    <div className="flex justify-between items-center gap-5">
                      <Heading size="s" as="h3" className="self-end mb-5 !text-black-900">
                        Upload Documents
                      </Heading>
                    ...
                    <div className="self-stretch h-[160px] relative">
                      ...
                      <div className="w-[23%] bottom-[0.00px] right-[0.33px] m-auto rounded-tl-[10px] bg-deep_purple-600 shadow-5xl absolute">
                        <Img
                          ...
                          alt="bag_one"
                          className="h-[84px] w-full md:h-auto rounded-tl-[10px]"
                        />
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex flex-col self-stretch items-center gap-[74px] p-14 md:gap-[55px] md:p-5 sm:gap-[37px] bg-white-A700">
            ...
            <div className="flex md:flex-col w-full gap-[49px] mx-auto max-w-[1197px]">
              ...
              <div className="flex flex-col w-full pb-[30px] pl-[30px] sm:pb-5 sm:pl-5 bg-deep_purple-600 shadow-lg rounded-[10px]">
          ...
          <div className="self-stretch px-14 py-[81px] md:p-5 bg-gray-100">
            <div className="flex md:flex-col justify-center items-center w-full mb-[29px] gap-10 mx-auto max-w-[1200px]">
              <div className="flex flex-col self-end items-start md:self-stretch flex-1">
                <Heading as="h2">
          ...
          <div className="flex md:flex-col self-stretch justify-center items-center gap-[26px] px-14 py-[95px] md:p-5 bg-gray-100">
